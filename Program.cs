...
plan.AddFactory(new Factory("Constructor (Iron Screw)") { Inputs = [new ResourceAmount("Iron Rod", 10)], Outputs = [new ResourceAmount("Iron Screw", 40)] });
...
plan.AddFactory(new Factory("Assembler Mk.1 (Rotor-Alt)") { Inputs = [new ResourceAmount("Copper Sheet", 22.5), new ResourceAmount("Iron Screw", 195)], Outputs = [new ResourceAmount("Rotor", 11.25)] });
...
plan.AddFactory(new Factory("Manufacturer (Computer)") { Inputs = [new ResourceAmount("Circuit Board", 25), new ResourceAmount("Cable", 22.5), new ResourceAmount("Plastic", 45), new ResourceAmount("Iron Screw", 130)], Outputs = [new ResourceAmount("Computer", 2.5)] });
